...
TEST(PictureTest, Iterator)
{
    ...
    // Add some actors
    auto actor1 = std::make_shared<Actor>(L"Bob");
    auto actor2 = std::make_shared<Actor>(L"Ted");
    auto actor3 = std::make_shared<Actor>(L"Carol");
    auto actor4 = std::make_shared<Actor>(L"Alice");
