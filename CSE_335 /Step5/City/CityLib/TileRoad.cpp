...
*/
TileRoad::TileRoad(City *city) : Tile(city)
{
 ...
 * @return Pointer to the crated node
 */
wxXmlNode* TileRoad::XmlSave(wxXmlNode* node)
{
    auto itemNode = Tile::XmlSave(node);

    itemNode->AddAttribute(L"type", L"road");
 ...
 */
void TileRoad::SetAdjacencies(bool ul, bool ur, bool ll, bool lr)
{
