...
BW_list=125000;
SF_list=7;
batch_list=0:100; %change
%batch_list=4:7;

for BW=BW_list
    for SF=SF_list
        chirp_down = Utils.gen_symbol(0,true);
        %chirp_down = Utils.gen_symbol(0,true, Fs, );
        ...
        feature_path = [data_root, '/Users/riyathakore/Desktop/CSE 891/Project1/Code/neural_enhanced_demodulation/matlab/eval/','baseline_error_matrix_',num2str(SF),'_',num2str(BW),'.mat'];
