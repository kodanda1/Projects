...
raw_data_dir = '/Users/riyathakore/Desktop/CSE 891/Project1/sf7_125k';
generated_data_dir = '/Users/riyathakore/Desktop/CSE 891/Project1/Generated/';
...
for raw_data_index=1:n_raw_data_list
    ...
    %%fprintf(size(chirp_raw));
    %%fprintf(size(chirp_down));
    chirp_dechirp = chirp_raw .* chirp_down; %element-wise multiplication
